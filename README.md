...
artifact link for reachability, checks primary audio artifact reachability,
checks expected error and forbidden path responses, and verifies local responses
