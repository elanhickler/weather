...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        ".addEventListener(\"pointerover\", handleNodeHoverTooltip)",
        ".addEventListener(\"click\", showTooltip)",
        ".addEventListener(\"click\", handleNodeHoverTooltip)",
        ".addEventListener(\"pointerout\", clearNodeHoverTooltip)",
        ".addEventListener(\"mouseover\", handleNodeHoverTooltip)",
        ".addEventListener(\"mouseout\", clearNodeHoverTooltip)",
        ".addEventListener(\"focusin\", handleNodeHoverTooltip)",
        ".addEventListener(\"focusout\", clearNodeHoverTooltip)",
        "data-ready",
        ...
        "sourceNodes",
        "nodeGraphFindInputConnections(node, \"In\").reduce",
        'if (type === "gain")',
