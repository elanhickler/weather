...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "\\b(?:dot[12]\\.(?:global|globals)\\.(?:size|brightness)|(?:dot[12]|blend|video)\\.[a-zA-Z_][\\w]*|globalsize|global\\.size)\\b",
        "\\b(?:laser|led|light|paint|solid|none|output\\d+)\\b|~",
        ...
        "normalizeNodeGraphModuleScopeDotCoreColor(nodeGraphMvp?.moduleScopeDotCore2Color ?? \"#17002f\", \"#17002f\")",
