...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "nodeGraphDependencyPathExists(orderDependencies, connection.sourceNode, connection.destinationNode)",
        ...
        "pathClass: `node-wire-path${feedbackSets.signal.has",
        "node-modulation-wire-path${feedbackSets.modulation.has",
