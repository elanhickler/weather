...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        'data-global-scope-input="dotCore1Color" value="#ffa3a8"',
    ...
    for snippet in [
        ...
        "const nodeUiDevDefaultSettingsStorageKey = \"soemdsp-sandbox.userUiSettings.startup.v6\"",
        ...
        "Prettyscope-style module scope shader",
        ...
        "normalizeNodeGraphModuleScopeDotCoreColor(nodeGraphMvp?.moduleScopeDotCore1Color ?? \"#ffa3a8\", \"#ffa3a8\")",
        "normalizeNodeGraphModuleScopeDotCoreColor(nodeGraphMvp?.moduleScopeDotCore2Color ?? \"#444444\", \"#444444\")",
