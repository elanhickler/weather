...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "unsaved: ${settingsText}; ignored lines",
        "unsaved: ${settingsText} ready",
        ...
        'moduleType === "visualOscilloscope" || moduleType === "spiral" || moduleType === "ellipsoid"',
        "blend.mode      = laser",
        ...
        'slot?.type === "spiral" || slot?.type === "ellipsoid"',
