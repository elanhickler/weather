...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "const passthroughTypes = new Set([\"badvalMonitor\", \"bias\", \"cookbookFilter\", \"flowerChildFilter\", \"gain\", \"ladderFilter\", \"passiveFilter\", \"pll\", \"reverbEffect\", \"sampleHold\", \"slewLimiter\", \"softClipper\", \"speakerProtection\"])",
