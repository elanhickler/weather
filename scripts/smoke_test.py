...
def require_readme_scheduler_contract() -> None:
    # This fork's README was intentionally rewritten to document the weather
    # synthesis work (RAIN) rather than preserve every prior fork's
    # accumulated content (that content still lives in the upstream
    # soemdsp-sandbox master history and in the analog-filters/supersaw
    # forks' own README history).
