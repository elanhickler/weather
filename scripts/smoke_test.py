...
def require_node_graph_mvp_contract() -> None:
    ...
    require('departments: Object.freeze(["Oscillator", "Chaos", "Jerobeam", "Noise", "Drum", "Sequence", "Envelope"])' in module_store_source, "Generate group should include Envelope")
    require('departments: Object.freeze(["Audio", "Delay", "Loops", "Samples"])' in module_store_source, "Memory group should include Delay")
