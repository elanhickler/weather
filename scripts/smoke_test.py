...
def require_readme_scheduler_contract() -> None:
    # This branch's README was intentionally rewritten to document the
    # aliasing-wars oscillator work rather than preserve upstream's full
    # CLAP-host API reference (that content still lives in docs/ and
    # tools/webui-clap-host/README.md, just no longer duplicated here).
