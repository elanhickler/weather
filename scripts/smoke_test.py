...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "--node-graph-resize-handle-left",
        "--node-graph-resize-handle-top",
        ...
        "fetch(\"/api/viewport-export/save\"",
        "setNodeGraphViewportLastFileMade(payload.path, { folder: payload.folder })",
        "await saveNodeGraphViewportBlobToDownloads(image.pngBlob, nodeGraphViewportImageFileName())",
        "MAX_VIEWPORT_EXPORT_JSON_BYTES",
