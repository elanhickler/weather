...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        require(snippet in server_source, f"server shader desktop export contract missing {snippet}")
    for snippet in [
    ...
    for name, source, snippets in [
        ...
        (
            ...
            [
                ...
                "node-module-graph-cursor-value",
                'data-graph-cursor',
                'mode: "cursor"',
                "mode: \"contour\"",
        ...
        (
            ...
            [
                ...
                'normalizeNodeGraphPatchParameter("graph", "outputMin", minValue)',
                'normalizeNodeGraphPatchParameter("graph", "outputMax", maxValue)',
        ...
        (
            ...
            [
                ...
                "[\"graph\", \"textBox\", \"valueSlider\"].includes(targetNode?.type)",
                "`${heightGu} height gu`",
        ...
        (
            ...
            [
                "editable-graph-range-1",
                "editable-graph-smooth-shape-1",
    ...
    for snippet in [
        ...
        "const nodeGraphShaderScriptScopeModes",
        ...
        "const phase = Number(nodeGraphModuleScopeClockPhasor(",
        ...
        "clamp((gaussian * 0.82 + core * 0.18) * textureAlpha * afterglow * uIntensity, 0.0, 1.0)",
    ...
    for snippet in [
        ...
        'node?.type === "led"',
        '"led input"',
        "./public/node-live-audio-worklet.js?v=editable-graph-smooth-shape-1",
    ]:
