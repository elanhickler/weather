...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "nodeSavedPatchesWindowButton",
        "nodeSavedPatchesWindow",
        "nodeSavedPatchesRefreshButton",
    ...
    for snippet in [
        ...
        "node-header-timing-row node-header-transport-row",
        "node-header-timing-row node-header-scope-row",
