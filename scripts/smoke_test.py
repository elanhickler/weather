...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        'parsed.path == "/api/youtube/upload"',
        "def upload_youtube_video(self) -> None:",
        "SOEMDSP_YOUTUBE_ACCESS_TOKEN",
    ...
    for name, source, snippets in [
        ...
        (
            ...
            ['node-live-audio-worklet.js?v=oscilloscope-buffered-inputs-1'],
        ),
    ]:
        for snippet in snippets:
    ...
    for snippet in [
        ...
        "nodeExportViewportYoutubeButton",
        ...
        "nodeViewportLastFolderBox",
        "nodeViewportLastFilePathBox",
        "nodeViewportOpenFolderButton",
        "nodeViewportOpenFileButton",
        "Open Folder",
        "Open File",
        r'value="C:\Users\argit\Downloads"',
        'value="file path: none"',
        "workspace.copyViewportImage",
        "scope-controls-lower-row-1",
        "nodeMasterScopeLineThickness",
        "nodeMasterScopeOverdrawPoints",
        "Overdraw adds guaranteed connector points between samples.",
        "Fade controls how strongly older overdraw points dim before the newest point.",
        ...
        'aria-pressed="true">Dot 1</button>',
        ...
        "scene-context-module-browser-button",
        "Module Browser",
        "nodeSceneCopyModule",
        "nodeSceneAddToGroup",
        "Add to group",
    ...
    for snippet in [
        ...
        "WIRE ACTIONS",
        "HOME MODULES",
        "menu.setAttribute(\"aria-label\", wireMode ? \"Wire actions\" : homeMode ? \"Home modules\"",
        ...
        "downloadNodeGraphViewportBlob(image.pngBlob, nodeGraphViewportImageFileName())",
        ...
        "document.addEventListener(\"DOMContentLoaded\", bindNodeGraphViewportPathButtons",
        "typeof setNodeGraphViewportLastFileMade === \"function\"",
        ...
        "window.prompt(\"YouTube title\"",
        "window.prompt(\"YouTube description\"",
    ...
    for snippet in [
        ...
        ".node-copy-viewport-youtube-button",
        ".node-copy-viewport-seconds-input",
        ".node-copy-viewport-width-input",
        ".node-viewport-path-row",
        ".node-viewport-path-box",
        ".node-viewport-path-open-button",
        "flex-wrap: wrap",
