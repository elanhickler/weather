...
PUBLIC_SCRIPT_PATHS = (
    ...
    "./public/node-graph-viewport-image.js",
...
REQUIRED_SHELL_IDS = {
    ...
    "saveNodeGraphScriptEditorButton",
...
def require_node_graph_mvp_contract() -> None:
    ...
    for snippet in [
        ...
        "nodeCopyViewportImageOverlayButton",
        "nodeExportViewportGifButton",
        "nodeExportViewportMp4Button",
        "nodeExportViewportWavButton",
        "nodeExportViewportOggButton",
        "nodeExportViewportFlacButton",
        "nodeViewportExportSecondsInput",
        "nodeViewportExportWidthInput",
        "workspace.copyViewportImage",
        "screen settings",
        "screen burn",
        "nodeMasterScopeBurn",
        ...
        'data-global-scope-input="dotCore1Size" data-global-scope-number-drag="true" value="3.18"',
        ...
        'id="nodeMasterScopeOverdrawFade" type="number" min="0" max="1" step="0.01"',
        ...
        "data-global-scope-input=\"overdrawFade\"",
    ...
    for snippet in [
        ...
        "No module departments match this search.",
        ...
        "function copyNodeGraphVisualOutputPngToClipboard()",
        ...
        "node-header-speed-placeholder-badge",
        "input.value = \"1.0\"",
        ...
        "parseNodeGraphScopeShaderNumber(normalizedSource, \"cycles\", 1.7639, 1, 128)",
        ...
        "script.layers || []",
        "--node-canvas-layer-x",
        "definition.layout === \"canvas\" ? \" canvas-node-layout\" : \"\"",
        ...
        "function nodeGraphViewportExportTargetWidth",
        ...
        "nodeGraphViewportCanvasImage(sourceCanvas)",
    ...
    for snippet in [
        ...
        ".node-copy-viewport-image-button",
        ".node-copy-viewport-wav-button",
        ".node-copy-viewport-ogg-button",
        ".node-copy-viewport-flac-button",
        ".node-copy-viewport-gif-button",
        ".node-copy-viewport-mp4-button",
        ".node-copy-viewport-seconds-input",
        ".node-copy-viewport-width-input",
        ...
        ".node-graph-workspace.module-buttons-hidden .dsp-node:not(.text-box-layout):not(.image-node-layout):not(.canvas-node-layout):not(.visual-scope-layout):not(.graph-node-layout):not(.slider-widget-layout)",
        "grid-template-rows: var(--node-header-height) var(--node-module-scope-height) auto auto minmax(0, 1fr)",
        ".node-graph-workspace.module-buttons-hidden .dsp-node:not(.text-box-layout):not(.image-node-layout):not(.canvas-node-layout):not(.visual-scope-layout):not(.graph-node-layout):not(.slider-widget-layout)::after",
        ...
        ".node-history-controls .node-header-tap-tempo-button",
        "inline-size: 1.15em",
